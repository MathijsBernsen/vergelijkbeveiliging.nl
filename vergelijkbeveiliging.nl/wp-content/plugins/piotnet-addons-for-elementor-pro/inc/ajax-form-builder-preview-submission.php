			...
			foreach ($fields as $field) {
				...
				if (!empty($repeater_id) && !empty($repeater_label) && $repeater_remove_this_field == false) {
					if (strpos($message, $repeater_label) !== false) {
						$message_all_fields .= '<div class="pafe-form-builder-preview-submission__item"><label class="pafe-form-builder-preview-submission__item-label">' . $field['label'] . ': </label>' . '<span class="pafe-form-builder-preview-submission__item-value">' . $field_value . '</span>' . '</div>';
					} else {
			...
			foreach ($fields as $field) {
				...
				if (!empty($repeater_id) && !empty($repeater_label) && $repeater_remove_this_field == false) {
					if (strpos($repeater_content, $repeater_label) !== false) {
						$string_add = '<div class="pafe-form-builder-preview-submission__item"><label class="pafe-form-builder-preview-submission__item-label">' . $field['label'] . ': </label>' . '<span class="pafe-form-builder-preview-submission__item-value">' . $field_value . '</span>' . '</div>';
						pafe_merge_string_preview($repeater_content,$string_add);
					} else {
						$string_add = $repeater_label . '<div class="pafe-form-builder-preview-submission__item"><label class="pafe-form-builder-preview-submission__item-label">' . $field['label'] . ': </label>' . '<span class="pafe-form-builder-preview-submission__item-value">' . $field_value . '</span>' . '</div>';
						pafe_merge_string_preview($repeater_content,$string_add);
					}
